...
from app.core.db_models.dem_models_table import create_dem_models_db_table
from app.core.db_models.imported_files_table import create_imported_files_table
from app.core.db_models.mesh_cell_table import create_mesh_cell_db_table
from app.core.db_models.points_scans_table import create_points_scans_db_table
from app.core.db_models.points_table import create_points_db_table
from app.core.db_models.scans_table import create_scans_db_table
from app.core.db_models.voxel_models_table import create_voxel_models_db_table
from app.core.db_models.voxels_table import create_voxels_db_table
